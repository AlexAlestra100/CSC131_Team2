...
const data = importingJson();// data set to json //DOSENT WORK
    ...
    for(let i = 0; i < oscarsData.length; i++){
        if(oscarsData[i].winner == searchKey){ //searchkey = true in html file
 ...
 //Kendall: make sure you're testing code outside the function
 importingJson().then(data => console.log(winnerSearch(data, true)));
